...
theme.font                                      = "Gugi Font 12"
theme.taglist_font                              = "Gugi 10"
...
theme.mpd = lain.widget.mpd({
    settings = function()
        ...
        elseif mpd_now.state == "pause" then
            widget:set_markup(markup.font(theme.font, " media player paused "))
...
theme.weather = lain.widget.weather({
    city_id = 3629655, -- placeholder (PZO, VE)
    notification_preset = { font = "Gugi 12", fg = theme.fg_normal },
